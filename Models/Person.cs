...
namespace HumanRightsTracker.Models
{
    ...
    public class Person : ActiveRecordValidationBase<Person>
    {
        ...
        [HasMany(typeof(Address), Table="Addresses", ColumnKey="person_id", Cascade=ManyRelationCascadeEnum.AllDeleteOrphan, Lazy=true)]
        ...
        [HasMany(typeof(InstitutionPerson), Table="InstitutionPeople", ColumnKey="person_id", Cascade=ManyRelationCascadeEnum.Delete, Lazy=true)]
